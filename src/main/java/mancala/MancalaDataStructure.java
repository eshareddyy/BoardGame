...
/**
 * Represents a Mancala data structure for the Mancala game. Do not change the
 * signature of any of the methods provided. You may add methods if you need
 * them. Do not add game logic to this class
 */
public class MancalaDataStructure implements java.io.Serializable {
	...
	private int pitPos(int pitNum) {
		/*
		 * Runtime execeptions don't need to be declared and are automatically passed up
		 * the chain until caught. This can replace the PitNotFoundException
		 */

		
		 if (pitNum >= 14 || pitNum <=0) { pitNum = 1; }
		 //System.out.println("Pint Numner is :"+pitNum);
		...
		int pos = pitNum;
		// System.out.println("pos Numner is :"pos); */
